...
App.Router.map(function () {
    this.resource('tables', function () {
        this.resource('table', {path: ':table_id'}); //nested resource driven by parent resource.
        // if your ui is nested, routes should be too
    }); //#tables
});
...
// ember generates this automatically due to nested route
